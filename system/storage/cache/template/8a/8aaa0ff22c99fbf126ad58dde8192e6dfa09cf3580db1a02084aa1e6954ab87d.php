...
class __TwigTemplate_cbf401bfa802876ad184f6db5b2000586613a8e80f6bf7120e438d9627acddd3 extends Template
{
    private $source;
    private $macros = [];
  ...
  \$('#button-history').on('click', function(e) {
    ...
    \$.ajax({
      ...
      success: function(json) {
        ...
        if (json['error']) {
           \$('#tab-history').prepend('<div class=\"alert alert-danger alert-dismissible\"><i class=\"fa fa-exclamation-circle\"></i> ' + json['error'] + ' <button type=\"button\" class=\"btn-close\" data-dismiss=\"alert\">&times;</button></div>');
        }

        if (json['success']) {
          \$('#tab-history').prepend('<div class=\"alert alert-success alert-dismissible\"><i class=\"fa fa-check-circle\"></i> ' + json['success'] + ' <button type=\"button\" class=\"btn-close\" data-dismiss=\"alert\">&times;</button></div>');

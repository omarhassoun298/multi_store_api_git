...
class __TwigTemplate_ae1db3d266a1b066208083c6fc26e94ebb94609062e3cff187bb2f53cb277c42 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t</div>
\t\t\t\t\t\t<div class=\"text-end\">
              <button type=\"button\" id=\"button-filter\" class=\"btn btn-danger\"><i class=\"fa fa-eraser\">Clear</i></button>

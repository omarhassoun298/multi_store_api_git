...
class __TwigTemplate_26dd7f3f806fea8c8d472bfe933565cd4837624e7bdc4a1c314bdd22cb08f5ee extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        ...
        if ((($context["sectionsDisplay"] ?? null) == "blocks")) {
          ...
          ";
                ...
                // line 43
                echo "          ";
                echo twig_call_macro($macros["_self"], "macro_renderBlogPosts", [$context, $context["item"]], 43, $context, $this->getSourceContext());
                echo "
        </div>
      ";
            }
          ...
          ";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
                ...
                if ((twig_get_attribute($this->env, $this->source, $context["item"], "tabType", [], "any", false, false, false, 64) != "link")) {
                  ...
                  ";
                        // line 67
                        echo twig_call_macro($macros["_self"], "macro_renderBlogPosts", [$context, $context["item"]], 67, $context, $this->getSourceContext());
                        echo "
                </div>
              ";
                    } else {
                  ...
                  ";
                        // line 71
                        echo twig_call_macro($macros["_self"], "macro_renderBlogPosts", [$context, $context["item"]], 71, $context, $this->getSourceContext());
                        echo "
                </template>
              ";
                    }
            ...
            <div class=\"";
              ...
              ";
                ...
                if (twig_get_attribute($this->env, $this->source, $context["item"], "active", [], "any", false, false, false, 93)) {
                  ...
                  ";
                    // line 95
                    echo twig_call_macro($macros["_self"], "macro_renderBlogPosts", [$context, $context["item"]], 95, $context, $this->getSourceContext());
                    echo "
                </div>
              ";
                } else {
                  ...
                  ";
                    // line 99
                    echo twig_call_macro($macros["_self"], "macro_renderBlogPosts", [$context, $context["item"]], 99, $context, $this->getSourceContext());
                    echo "
                </template>
              ";
                }
...
";
    ...
    // line 1
    public function macro_renderBlogPosts($__context__ = null, $__item__ = null, ...$__varargs__)
    {
        $macros = $this->macros;
        ...
        try {
            ...
            if (((twig_get_attribute($this->env, $this->source, ($context["context"] ?? null), "gridType", [], "any", false, false, false, 3) == "ipr") && twig_get_attribute($this->env, $this->source, ($context["context"] ?? null), "swiper_carousel", [], "any", false, false, false, 3))) {
                ...
                if ((twig_get_attribute($this->env, $this->source, ($context["context"] ?? null), "display", [], "any", false, false, false, 4) == "grid")) {
      ...
      <div class=\"swiper-container\" ";
        ...
        <div class=\"swiper-wrapper post-";
                // line 6
                echo twig_get_attribute($this->env, $this->source, ($context["context"] ?? null), "display", [], "any", false, false, false, 6);
                echo " ipr-grid\">
          ";
                // line 7
                echo twig_get_attribute($this->env, $this->source, ($context["item"] ?? null), "posts", [], "any", false, false, false, 7);
                echo "
        </div>
      </div>
  ...
  ";
                ...
                // line 17
                echo "    <div class=\"post-";
                echo twig_get_attribute($this->env, $this->source, ($context["context"] ?? null), "display", [], "any", false, false, false, 17);
                echo " no-scroll ";
      ...
      ";
          ...
          ";
                    // line 20
                    echo twig_get_attribute($this->env, $this->source, ($context["item"] ?? null), "posts", [], "any", false, false, false, 20);
                    echo "
        </div>
      ...
      ";
                    ...
                    // line 25
                    echo "        ";
                    echo twig_get_attribute($this->env, $this->source, ($context["item"] ?? null), "posts", [], "any", false, false, false, 25);
                    echo "
      ";
                }
                // line 27

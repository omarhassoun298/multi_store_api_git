...
/* journal3/template/journal3/blog_side_posts.twig */
class __TwigTemplate_8ccef61734b596b12d985fa2c2230d1e extends Template
{
    private $source;
    private $macros = [];
        ...
        <a href=\"";
          ...
          ";
            ...
            if (twig_get_attribute($this->env, $this->source, ($context["journal3"] ?? null), "get", ["performanceLazyLoadImagesStatus"], "method", false, false, false, 6)) {
                ...
                echo "\" alt=\"";
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["post"], "name", [], "any", false, false, false, 7));
                echo "\" title=\"";
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["post"], "name", [], "any", false, false, false, 7));
          ...
          ";
                ...
                echo ($context["image_height"] ?? null);
                echo "\" alt=\"";
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["post"], "name", [], "any", false, false, false, 9));
                echo "\" title=\"";
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["post"], "name", [], "any", false, false, false, 9));
...
";
    ...
    {
        return "journal3/template/journal3/blog_side_posts.twig";
    }
    ...
    {
        return new Source("", "journal3/template/journal3/blog_side_posts.twig", "");
    }
}

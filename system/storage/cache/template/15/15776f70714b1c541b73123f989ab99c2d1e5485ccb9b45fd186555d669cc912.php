...
class __TwigTemplate_b7860d37558a3429a256a5aafcf29b3f8e51d7b48e4923a10c7abf6f2fd60730 extends Template
{
    private $source;
    private $macros = [];
  ...
  \$('#button-history').on('click', function(e) {
    ...
    \$.ajax({
      ...
      success: function(json) {
        ...
        if (json['error']) {
           \$('#tab-history').prepend('<div class=\"alert alert-danger alert-dismissible\"><i class=\"fa fa-exclamation-circle\"></i> ' + json['error'] + ' <button type=\"button\" class=\"btn-close\" data-dismiss=\"alert\"></button></div>');
        }

        if (json['success']) {
          \$('#tab-history').prepend('<div class=\"alert alert-success alert-dismissible\"><i class=\"fa fa-check-circle\"></i> ' + json['success'] + ' <button type=\"button\" class=\"btn-close\" data-dismiss=\"alert\"></button></div>');
  ...
  \$('#button-transaction').on('click', function(e) {
    ...
    \$.ajax({
      ...
      success: function(json) {
        ...
        if (json['error']) {
           \$('#tab-transaction').prepend('<div class=\"alert alert-danger alert-dismissible\"><i class=\"fa fa-exclamation-circle\"></i> ' + json['error'] + ' <button type=\"button\" class=\"btn-close\" data-dismiss=\"alert\"></button></div>');
        }

        if (json['success']) {
          \$('#tab-transaction').prepend('<div class=\"alert alert-success alert-dismissible\"><i class=\"fa fa-check-circle\"></i> ' + json['success'] + ' <button type=\"button\" class=\"btn-close\" data-dismiss=\"alert\"></button></div>');
  ...
  \$('#button-reward').on('click', function(e) {
    ...
    \$.ajax({
      ...
      success: function(json) {
        ...
        if (json['error']) {
           \$('#tab-reward').prepend('<div class=\"alert alert-danger alert-dismissible\"><i class=\"fa fa-exclamation-circle\"></i> ' + json['error'] + ' <button type=\"button\" class=\"btn-close\" data-dismiss=\"alert\"></button></div>');
        }

        if (json['success']) {
          \$('#tab-reward').prepend('<div class=\"alert alert-success alert-dismissible\"><i class=\"fa fa-check-circle\"></i> ' + json['success'] + ' <button type=\"button\" class=\"btn-close\" data-dismiss=\"alert\"></button></div>');

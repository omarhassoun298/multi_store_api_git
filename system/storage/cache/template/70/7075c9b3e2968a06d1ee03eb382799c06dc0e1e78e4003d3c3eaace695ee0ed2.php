...
class __TwigTemplate_48c100eb65fe47e8e5146ed383fc1c48140dcf807a148903389e83a0a1e1c983 extends Template
{
    private $source;
    private $macros = [];
...
\$('#button-address').on('click', function (e) {
  ...
  ";
                    ...
                    foreach ($context['_seq'] as $context["_key"] => $context["custom_field_value"]) {
                        // line 995
                        echo "    html += '  \t\t       <input type=\"radio\" name=\"address[' + address_row + '][custom_field][";

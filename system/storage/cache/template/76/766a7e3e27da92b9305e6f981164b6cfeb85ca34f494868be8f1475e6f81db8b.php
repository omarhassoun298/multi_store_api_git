...
class __TwigTemplate_cd73bc5c483a3ed9ea26d2f635a1f5fcc0aa37ef3d091ab05b9b94797d0747d4 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t</div>
\t\t\t\t\t\t<div class=\"text-end\">
              <button type=\"button\" id=\"button-filter\" class=\"btn btn-danger\"><i class=\"\"></i>Clear</button>

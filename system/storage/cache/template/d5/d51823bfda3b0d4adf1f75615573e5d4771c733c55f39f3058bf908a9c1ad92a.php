...
class __TwigTemplate_28f456036d8237b47877fec0c2225690537e9ae6d1457ef22d54a3df77e65897 extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        ...
        if ((($context["sectionsDisplay"] ?? null) == "blocks")) {
          ...
          ";
                ...
                // line 43
                echo "          ";
                echo twig_call_macro($macros["_self"], "macro_renderManufacturers", [$context, $context["item"]], 43, $context, $this->getSourceContext());
                echo "
        </div>
      ";
            }
          ...
          ";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
                ...
                if ((twig_get_attribute($this->env, $this->source, $context["item"], "tabType", [], "any", false, false, false, 64) != "link")) {
                  ...
                  ";
                        // line 67
                        echo twig_call_macro($macros["_self"], "macro_renderManufacturers", [$context, $context["item"]], 67, $context, $this->getSourceContext());
                        echo "
                </div>
              ";
                    } else {
                  ...
                  ";
                        // line 71
                        echo twig_call_macro($macros["_self"], "macro_renderManufacturers", [$context, $context["item"]], 71, $context, $this->getSourceContext());
                        echo "
                </template>
              ";
                    }
            ...
            <div class=\"";
              ...
              ";
                ...
                if (twig_get_attribute($this->env, $this->source, $context["item"], "active", [], "any", false, false, false, 93)) {
                  ...
                  ";
                    // line 95
                    echo twig_call_macro($macros["_self"], "macro_renderManufacturers", [$context, $context["item"]], 95, $context, $this->getSourceContext());
                    echo "
                </div>
              ";
                } else {
                  ...
                  ";
                    // line 99
                    echo twig_call_macro($macros["_self"], "macro_renderManufacturers", [$context, $context["item"]], 99, $context, $this->getSourceContext());
                    echo "
                </template>
              ";
                }
...
";
    ...
    // line 1
    public function macro_renderManufacturers($__context__ = null, $__item__ = null, ...$__varargs__)
    {
        $macros = $this->macros;
      ...
      <div class=\"swiper-container\" ";
        ...
        <div class=\"swiper-wrapper manufacturer-grid ipr-grid\">
          ";
                // line 7
                echo twig_get_attribute($this->env, $this->source, ($context["item"] ?? null), "manufacturers", [], "any", false, false, false, 7);
                echo "
        </div>
      </div>
  ...
  ";
                ...
                // line 17
                echo "    <div class=\"manufacturer-grid no-scroll ";
      ...
      ";
          ...
          ";
                    // line 20
                    echo twig_get_attribute($this->env, $this->source, ($context["item"] ?? null), "manufacturers", [], "any", false, false, false, 20);
                    echo "
        </div>
      ...
      ";
                    ...
                    // line 25
                    echo "        ";
                    echo twig_get_attribute($this->env, $this->source, ($context["item"] ?? null), "manufacturers", [], "any", false, false, false, 25);
                    echo "
      ";
                }
                // line 27

...
class __TwigTemplate_a1cd1fe3483a914efacf7e2ab896ae385b3e1160bb517f9a519fccaed93d7579 extends Template
{
    private $source;
    private $macros = [];
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["keyword"]) {
                ...
                echo "                <tr>
                  <td class=\"text-center\">
                    ";
                // line 51
                if (twig_in_filter(twig_get_attribute($this->env, $this->source, $context["keyword"], "keyword_id", [], "any", false, false, false, 51), ($context["selected"] ?? null))) {
                    // line 52
                    echo "                    <input type=\"checkbox\" class=\"form-check-input\" name=\"selected[]\" value=\"";
                    echo twig_get_attribute($this->env, $this->source, $context["keyword"], "keyword_id", [], "any", false, false, false, 52);
                    echo "\" checked />
                    ";
                } else {
                    // line 54
                    echo "                    <input type=\"checkbox\" class=\"form-check-input\" name=\"selected[]\" value=\"";
                    echo twig_get_attribute($this->env, $this->source, $context["keyword"], "keyword_id", [], "any", false, false, false, 54);
                    echo "\" />
                    ";
                }
                // line 56
                echo "                  </td>
                  <td class=\"text-left\">";
                // line 57
                echo twig_get_attribute($this->env, $this->source, $context["keyword"], "name", [], "any", false, false, false, 57);
                echo "</td>       
                 <td class=\"text-end\">
                    <a href=\"";
                // line 59
                echo twig_get_attribute($this->env, $this->source, $context["keyword"], "edit", [], "any", false, false, false, 59);
                echo "\" data-bs-toggle=\"tooltip\" title=\"";
...
";
    ...
    {
        return array (  216 => 82,  207 => 76,  203 => 75,  196 => 70,  190 => 67,  187 => 66,  184 => 65,  170 => 59,  165 => 57,  162 => 56,  156 => 54,  150 => 52,  148 => 51,  144 => 49,  139 => 48,  137 => 47,  130 => 43,  118 => 34,  112 => 31,  108 => 29,  102 => 27,  99 => 26,  93 => 24,  91 => 23,  85 => 19,  74 => 17,  70 => 16,  65 => 14,  58 => 10,  54 => 9,  46 => 6,  37 => 1,);
    }

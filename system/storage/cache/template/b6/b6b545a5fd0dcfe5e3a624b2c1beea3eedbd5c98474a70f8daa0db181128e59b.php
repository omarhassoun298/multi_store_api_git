...
class __TwigTemplate_86999c23de781ef6a8832160f803d8d142886dd399683f4068e8e45364b035a4 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t</div>
\t\t\t\t\t\t<div class=\"text-end\">
              <button type=\"button\" id=\"button-filter\" class=\"btn btn-danger\"><i class=\"fa fa-eraser\"></i> Clear</button>

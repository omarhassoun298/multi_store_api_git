...
class __TwigTemplate_52ebeed59a3b155ee6cc78c4b574291f extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        ...
        if ((($context["sectionsDisplay"] ?? null) == "blocks")) {
          ...
          ";
                ...
                // line 43
                echo "          ";
                echo twig_call_macro($macros["_self"], "macro_renderBlogSidePosts", [$context, $context["item"]], 43, $context, $this->getSourceContext());
                echo "
        </div>
      ";
            }
          ...
          ";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
                ...
                if ((twig_get_attribute($this->env, $this->source, $context["item"], "tabType", [], "any", false, false, false, 64) != "link")) {
                  ...
                  ";
                        // line 67
                        echo twig_call_macro($macros["_self"], "macro_renderBlogSidePosts", [$context, $context["item"]], 67, $context, $this->getSourceContext());
                        echo "
                </div>
              ";
                    } else {
                  ...
                  ";
                        // line 71
                        echo twig_call_macro($macros["_self"], "macro_renderBlogSidePosts", [$context, $context["item"]], 71, $context, $this->getSourceContext());
                        echo "
                </template>
              ";
                    }
            ...
            <div class=\"";
              ...
              ";
                ...
                if (twig_get_attribute($this->env, $this->source, $context["item"], "active", [], "any", false, false, false, 93)) {
                  ...
                  ";
                    // line 95
                    echo twig_call_macro($macros["_self"], "macro_renderBlogSidePosts", [$context, $context["item"]], 95, $context, $this->getSourceContext());
                    echo "
                </div>
              ";
                } else {
                  ...
                  ";
                    // line 99
                    echo twig_call_macro($macros["_self"], "macro_renderBlogSidePosts", [$context, $context["item"]], 99, $context, $this->getSourceContext());
                    echo "
                </template>
              ";
                }
...
";
    ...
    // line 1
    public function macro_renderBlogSidePosts($__context__ = null, $__item__ = null, ...$__varargs__)
    {
        $macros = $this->macros;
  ...
  ";
                ...
                // line 17
                echo "    <div class=\"side-posts no-scroll ";

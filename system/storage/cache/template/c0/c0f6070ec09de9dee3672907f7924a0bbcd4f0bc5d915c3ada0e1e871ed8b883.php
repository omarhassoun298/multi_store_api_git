...
class __TwigTemplate_9dba027fd8df77a35ebbbf4651621d87ef00dfc5a449fe3aac6630b6296ec993 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t</div>
\t\t\t\t\t\t<div class=\"text-end\">
              <button type=\"button\" id=\"button-filter\" class=\"btn btn-danger\"><i class=\"fa-solid fa-filter\"></i>Clear</button>

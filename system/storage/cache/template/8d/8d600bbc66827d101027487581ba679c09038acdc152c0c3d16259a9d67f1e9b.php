...
class __TwigTemplate_1ad36b5795f144581ca76ae7a0b41f948e0f40f3543395abd7315639abbf5b0b extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t<button type=\"button\" id=\"button-clear\" class=\"btn btn-light\"><i class=\"fa-solid fa-filter\"></i> ";
        // line 35
        echo ($context["button_filter"] ?? null);
        echo "</button>
\t\t\t\t\t\t</div>

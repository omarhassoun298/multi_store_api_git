...
class Customer {
	...
	public function __construct($registry) {
		...
		$this->url_prefix = $this->request->server['HTTPS'] ? HTTPS_SERVER : HTTP_SERVER;

		$registry->get('load')->model('tool/image');
        $this->img_model = $registry->get('model_tool_image');
		...
		if (isset($this->session->data['customer_id'])) {
			...
			if ($customer_query->num_rows) {
				...
				$this->completed = $customer_query->row['completed'];
	...
	public function getCustomer(){
		if($this->customer_id){
			$customer_info = array(
				...
				'age' => $this->getAge(),
				'image' => !empty($this->image) ? $this->url_prefix.'image/'.$this->image : '',
				'completed' => (bool)$this->completed,
				'balance' => $this->currency->format($this->getBalance(), 'USD')
			);	

...
<div class="well">
    ...
    <div id="filters" class="row filters-switcher <?php echo (isset($_COOKIE['show-so-filters']) && $_COOKIE['show-so-filters'] == 1) ? '' : 'row hide-filters'; ?>">    
      ...
      <?php } ?>
      <?php if (in_array('campaign_name', $advso_settings_filters)) { ?>      
    	<div class="col-lg-2" style="height:75px;">
      ...
      <?php } ?>
      <?php if (in_array('campaign_code', $advso_settings_filters)) { ?>      
    	<div class="col-lg-2" style="height:75px;">
			...
			<?php foreach ($advso_load_save_reports as $advso_load_save_report) { ?>
			  <tbody id="adv_load_save_reports_row<?php echo $adv_load_save_reports_row; ?>">
				<tr> 
				  ...
				  <td width="10%" class="text-center"><button type="button" onclick="location = '<?php echo ($report_link . str_replace('index.php?route=extension/report/adv_sales', '', $advso_load_save_report['save_report_link'])); ?>'" title="<?php echo $button_load; ?> Report" class="btn btn-primary"><i class="fa fa-circle-o-notch"></i> <?php echo $button_load; ?></button></td>                                
				</tr>             
			  </tbody>
...
<?php if ($filter_report != 'tax' && $filter_report != 'coupon' && $filter_report != 'voucher') { ?>                    
		...
		<div id="checkbox_mv_column" class="row">
			<div class="col-sm-12">
				...
				<div class="well well-sm" style="background:#f5f5f5; height:180px; overflow:auto;">
                	<div class="col-sm-12" align="right" style="margin-top:10px;">
...
<?php if ($filter_report == 'tax') { ?>                    
		...
		<div id="checkbox_tr_column" class="row">
			<div class="col-sm-12">
               	<label class="control-label"><i class="fa fa-columns"></i> <?php echo $text_mv_columns; ?></label>
				<div class="well well-sm" style="background:#f5f5f5; height:100px; overflow:auto;">
                	<div class="col-sm-12" align="right" style="margin-top:10px;">
...
<?php if ($filter_report == 'voucher') { ?>                    
		...
		<div id="checkbox_vr_column" class="row">
			<div class="col-sm-12">
               	<label class="control-label"><i class="fa fa-columns"></i> <?php echo $text_mv_columns; ?></label>
				<div class="well well-sm" style="background:#f5f5f5; height:150px; overflow:auto;">
                	<div class="col-sm-12" align="right" style="margin-top:10px;">
...
<?php if ($filter_report != 'tax') { ?>
		<div class="row">
			<div class="col-sm-12">
				...
				<div class="well well-sm" style="background:#f5f5f5; height:410px; overflow:auto;">
...
<?php if ($filter_report != 'tax') { ?>
		<div id="checkbox_all_column" class="row">
			<div class="col-sm-12">
				...
				<div class="well well-sm" style="background:#f5f5f5; height:500px; overflow:auto;">
                	<div class="col-sm-12" align="right" style="margin-top:10px;">
			...
			<?php foreach ($advso_cron_settings as $advso_cron_setting) { ?>
			  <tbody id="adv_cron_settings_row<?php echo $adv_cron_settings_row; ?>">
				<tr>                
                  ...
                  <input type="hidden" name="advso_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_campaign_name]" value="<?php echo $advso_cron_setting['cron_filter_campaign_name']; ?>" />
                  <input type="hidden" name="advso_cron_setting[<?php echo $adv_cron_settings_row; ?>][cron_filter_campaign_code]" value="<?php echo $advso_cron_setting['cron_filter_campaign_code']; ?>" />
...
$(document).ready(function() {
	$.ajax({
		url: 'index.php?route=extension/report/adv_sales/chart&user_token=<?php echo $user_token; ?>',
		dataType: 'json',
...
<?php if ($filter_details == 'all_details_products' or $filter_details == 'all_details_orders') { ?>
	...
	<?php if ($orders && $filter_limit != '999999') { ?>          
		...
		<tr>
          ...
          <?php } ?>
          <?php if (in_array('all_campaign_name', $advso_settings_all_columns)) { ?>          
          <td class="left" nowrap="nowrap"><?php echo $column_campaign_name; ?></td>
          <?php } ?> 
          <?php if (in_array('all_campaign_code', $advso_settings_all_columns)) { ?>          
...
<script type="text/javascript">
function filter() {
	url = 'index.php?route=extension/report/adv_sales&user_token=<?php echo $user_token; ?>';										 
...
$('input[name=\'filter_customer_name\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=extension/report/adv_sales/customer_autocomplete&user_token=<?php echo $user_token; ?>&filter_customer_name=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {		
...
$('input[name=\'filter_customer_email\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=extension/report/adv_sales/customer_autocomplete&user_token=<?php echo $user_token; ?>&filter_customer_email=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {		
				response($.map(json, function(item) {
					return {
...
$('input[name=\'filter_customer_telephone\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=extension/report/adv_sales/customer_autocomplete&user_token=<?php echo $user_token; ?>&filter_customer_telephone=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {		
				response($.map(json, function(item) {
					return {
...
$('input[name=\'filter_ip\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=extension/report/adv_sales/customer_autocomplete&user_token=<?php echo $user_token; ?>&filter_ip=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {		
				response($.map(json, function(item) {
					return {
...
$('input[name=\'filter_payment_company\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=extension/report/adv_sales/customer_autocomplete&user_token=<?php echo $user_token; ?>&filter_payment_company=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {		
				response($.map(json, function(item) {
					return {
...
$('input[name=\'filter_payment_address\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=extension/report/adv_sales/customer_autocomplete&user_token=<?php echo $user_token; ?>&filter_payment_address=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {		
				response($.map(json, function(item) {
					return {
...
$('input[name=\'filter_payment_city\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=extension/report/adv_sales/customer_autocomplete&user_token=<?php echo $user_token; ?>&filter_payment_city=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {		
				response($.map(json, function(item) {
					return {
...
$('input[name=\'filter_payment_zone\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=extension/report/adv_sales/customer_autocomplete&user_token=<?php echo $user_token; ?>&filter_payment_zone=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {		
				response($.map(json, function(item) {
					return {
...
$('input[name=\'filter_payment_postcode\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=extension/report/adv_sales/customer_autocomplete&user_token=<?php echo $user_token; ?>&filter_payment_postcode=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {		
				response($.map(json, function(item) {
					return {
...
$('input[name=\'filter_payment_country\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=extension/report/adv_sales/customer_autocomplete&user_token=<?php echo $user_token; ?>&filter_payment_country=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {		
				response($.map(json, function(item) {
					return {
...
$('input[name=\'filter_shipping_company\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=extension/report/adv_sales/customer_autocomplete&user_token=<?php echo $user_token; ?>&filter_shipping_company=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {		
				response($.map(json, function(item) {
					return {
...
$('input[name=\'filter_shipping_address\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=extension/report/adv_sales/customer_autocomplete&user_token=<?php echo $user_token; ?>&filter_shipping_address=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {		
				response($.map(json, function(item) {
					return {
...
$('input[name=\'filter_shipping_city\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=extension/report/adv_sales/customer_autocomplete&user_token=<?php echo $user_token; ?>&filter_shipping_city=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {		
				response($.map(json, function(item) {
					return {
...
$('input[name=\'filter_shipping_zone\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=extension/report/adv_sales/customer_autocomplete&user_token=<?php echo $user_token; ?>&filter_shipping_zone=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {		
				response($.map(json, function(item) {
					return {
...
$('input[name=\'filter_shipping_postcode\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=extension/report/adv_sales/customer_autocomplete&user_token=<?php echo $user_token; ?>&filter_shipping_postcode=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {		
				response($.map(json, function(item) {
					return {
...
$('input[name=\'filter_shipping_country\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=extension/report/adv_sales/customer_autocomplete&user_token=<?php echo $user_token; ?>&filter_shipping_country=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {		
				response($.map(json, function(item) {
					return {
...
$('input[name=\'filter_sku\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=extension/report/adv_sales/product_autocomplete&user_token=<?php echo $user_token; ?>&filter_sku=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {		
				response($.map(json, function(item) {
					return {
...
$('input[name=\'filter_product_name\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=extension/report/adv_sales/product_autocomplete&user_token=<?php echo $user_token; ?>&filter_product_name=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {		
				response($.map(json, function(item) {
					return {
...
$('input[name=\'filter_model\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=extension/report/adv_sales/product_autocomplete&user_token=<?php echo $user_token; ?>&filter_model=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {		
				response($.map(json, function(item) {
					return {
...
$('input[name=\'filter_coupon_code\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=extension/report/adv_sales/coupon_autocomplete&user_token=<?php echo $user_token; ?>&filter_coupon_code=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {		
				response($.map(json, function(item) {
					return {
...
$('input[name=\'filter_voucher_code\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=extension/report/adv_sales/voucher_autocomplete&user_token=<?php echo $user_token; ?>&filter_voucher_code=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {		
				response($.map(json, function(item) {
					return {
...
$('input[name=\'filter_campaign_code\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=extension/report/adv_sales/campaign_autocomplete&user_token=<?php echo $user_token; ?>&filter_campaign_code=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {		
				response($.map(json, function(item) {
					return {
...
$('#save_settings').on('click', function(){
	$.ajax ({
		url: 'index.php?route=extension/report/adv_sales/settings&user_token=<?php echo $user_token; ?>',		
		type: 'post',
...
$('#save_report').on('click', function(){
	$.ajax ({
		url: 'index.php?route=extension/report/adv_sales/load_save_report&user_token=<?php echo $user_token; ?>',		
		type: 'post',
...
function addCron() {
	...
	html += '<input type="hidden" id="cron_filter_campaign_name" name="advso_cron_setting[' + adv_cron_settings_row + '][cron_filter_campaign_name]" value="" />';
	html += '<input type="hidden" id="cron_filter_campaign_code" name="advso_cron_setting[' + adv_cron_settings_row + '][cron_filter_campaign_code]" value="" />';
...
$('#export_report').on('click', function(){
	var url_exp ='index.php?route=extension/report/adv_sales/export&user_token=<?php echo $user_token; ?>';
	...
	$.ajax ({
		url: 'index.php?route=extension/report/adv_sales/export_validate&user_token=<?php echo $user_token; ?>',
		type: 'post',
...
$('#save_cron').on('click', function(){
	...
	$.ajax ({
		url: 'index.php?route=extension/report/adv_sales/cron&user_token=<?php echo $user_token; ?>',		
		type: 'post',
...
function cron_command() {
	...
	var addr = link+"&cron_route="+"extension/report/adv_sales"+"&user_id="+user+"&cron_token="+token+"&cron_id="+id+"&cron=1";

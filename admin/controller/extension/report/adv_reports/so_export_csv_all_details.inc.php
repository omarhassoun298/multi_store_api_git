<?php
	...
	$custom_fields_name = $this->model_extension_report_adv_sales->getCustomFieldsNames($filter_data);
	}
	...
	in_array('all_campaign_name', $advso_settings_all_columns) ? $export_csv_all_details .= $csv_delimiter . $csv_enclosed . $this->language->get('column_campaign_name') . $csv_enclosed : '';	
	in_array('all_campaign_code', $advso_settings_all_columns) ? $export_csv_all_details .= $csv_delimiter . $csv_enclosed . $this->language->get('column_campaign_code') . $csv_enclosed : '';	
	...
	in_array('all_prod_category', $advso_settings_all_columns) ? $export_csv_all_details .= $csv_delimiter . $csv_enclosed . html_entity_decode($result['product_category'] !== NULL ? $result['product_category'] : '') . $csv_enclosed : '';		
	in_array('all_prod_manu', $advso_settings_all_columns) ? $export_csv_all_details .= $csv_delimiter . $csv_enclosed . html_entity_decode($result['product_manu'] !== NULL ? $result['product_manu'] : '') . $csv_enclosed : '';
	}
 	if ($filter_details == 'all_details_products' or $filter_details == 'all_details_orders') {	
	...
	if ($filter_details == 'all_details_products') {	
	in_array('all_prod_price', $advso_settings_all_columns) ? $export_csv_all_details .= $csv_delimiter . $csv_enclosed . sprintf('%0.2f', round($result['product_price_raw'], 2)) . $csv_enclosed : '';
	...
	in_array('all_prod_total_excl_vat', $advso_settings_all_columns) ? $export_csv_all_details .= $csv_delimiter . $csv_enclosed . sprintf('%0.2f', round($result['product_total_excl_vat_raw'], 2)) . $csv_enclosed : '';	
	in_array('all_prod_tax', $advso_settings_all_columns) ? $export_csv_all_details .= $csv_delimiter . $csv_enclosed . sprintf('%0.2f', round($result['product_tax_raw'], 2)) . $csv_enclosed : '';		
	in_array('all_prod_total_incl_vat', $advso_settings_all_columns) ? $export_csv_all_details .= $csv_delimiter . $csv_enclosed . sprintf('%0.2f', round($result['product_total_incl_vat_raw'], 2)) . $csv_enclosed : '';
	...
	in_array('all_prod_refund', $advso_settings_all_columns) ? $export_csv_all_details .= $csv_delimiter . $csv_enclosed . ($result['product_refund_raw'] != NULL ? sprintf('%0.2f', round($result['product_refund_raw'], 2)) : sprintf('%0.2f', round('0', 2))) . $csv_enclosed : '';
	...
	in_array('all_sub_total', $advso_settings_all_columns) ? $export_csv_all_details .= $csv_delimiter . $csv_enclosed . sprintf('%0.2f', round($result['order_sub_total_raw'], 2)) . $csv_enclosed : '';
	in_array('all_handling', $advso_settings_all_columns) ? $export_csv_all_details .= $csv_delimiter . $csv_enclosed . sprintf('%0.2f', round($result['order_handling_raw'] !== NULL ? $result['order_handling_raw'] : 0, 2)) . $csv_enclosed : '';
	in_array('all_loworder', $advso_settings_all_columns) ? $export_csv_all_details .= $csv_delimiter . $csv_enclosed . sprintf('%0.2f', round($result['order_low_order_fee_raw'] !== NULL ? $result['order_low_order_fee_raw'] : 0, 2)) . $csv_enclosed : '';
	in_array('all_shipping', $advso_settings_all_columns) ? $export_csv_all_details .= $csv_delimiter . $csv_enclosed . sprintf('%0.2f', round($result['order_shipping_raw'] !== NULL ? $result['order_shipping_raw'] : 0, 2)) . $csv_enclosed : '';
	in_array('all_reward', $advso_settings_all_columns) ? $export_csv_all_details .= $csv_delimiter . $csv_enclosed . sprintf('%0.2f', round($result['order_reward_raw'] !== NULL ? $result['order_reward_raw'] : 0, 2)) . $csv_enclosed : '';
	...
	in_array('all_coupon', $advso_settings_all_columns) ? $export_csv_all_details .= $csv_delimiter . $csv_enclosed . sprintf('%0.2f', round($result['order_coupon_raw'] !== NULL ? $result['order_coupon_raw'] : 0, 2)) . $csv_enclosed : '';
	...
	in_array('all_order_tax', $advso_settings_all_columns) ? $export_csv_all_details .= $csv_delimiter . $csv_enclosed . sprintf('%0.2f', round($result['order_tax_raw'] !== NULL ? $result['order_tax_raw'] : 0, 2)) . $csv_enclosed : '';
	in_array('all_credit', $advso_settings_all_columns) ? $export_csv_all_details .= $csv_delimiter . $csv_enclosed . sprintf('%0.2f', round($result['order_credit_raw'] !== NULL ? $result['order_credit_raw'] : 0, 2)) . $csv_enclosed : '';	
	in_array('all_voucher', $advso_settings_all_columns) ? $export_csv_all_details .= $csv_delimiter . $csv_enclosed . sprintf('%0.2f', round($result['order_voucher_raw'] !== NULL ? $result['order_voucher_raw'] : 0, 2)) . $csv_enclosed : '';
	...
	in_array('all_order_commission', $advso_settings_all_columns) ? $export_csv_all_details .= $csv_delimiter . $csv_enclosed . sprintf('%0.2f', round($result['order_commission_raw'] !== NULL ? -$result['order_commission_raw'] : 0, 2)) . $csv_enclosed : '';	
	in_array('all_order_value', $advso_settings_all_columns) ? $export_csv_all_details .= $csv_delimiter . $csv_enclosed . sprintf('%0.2f', round($result['order_value_raw'], 2)) . $csv_enclosed : '';
	in_array('all_refund', $advso_settings_all_columns) ? $export_csv_all_details .= $csv_delimiter . $csv_enclosed . ($result['order_refund_raw'] != NULL ? sprintf('%0.2f', round($result['order_refund_raw'], 2)) : sprintf('%0.2f', round('0', 2))) . $csv_enclosed : '';
	...
	in_array('all_campaign_name', $advso_settings_all_columns) ? $export_csv_all_details .= $csv_delimiter . $csv_enclosed . $result['order_campaign_name'] . $csv_enclosed : '';	
	in_array('all_campaign_code', $advso_settings_all_columns) ? $export_csv_all_details .= $csv_delimiter . $csv_enclosed . $result['order_campaign_code'] . $csv_enclosed : '';	

<?php
	...
	$sheet->setTitle('ADV Sales Report');
	...
	if ($export_logo_criteria ? $this->mainCounter = 2 : $this->mainCounter = 1) {
		 ...
		 if (in_array('all_campaign_name', $advso_settings_all_columns)) {
		 $col = \PhpOffice\PhpSpreadsheet\Cell\Coordinate::stringFromColumnIndex($j++);
		 ...
		 if (in_array('all_campaign_code', $advso_settings_all_columns)) {
		 $col = \PhpOffice\PhpSpreadsheet\Cell\Coordinate::stringFromColumnIndex($j++);
		 ...
		 if ($export_logo_criteria) {
			...
			$sheet->setCellValue('C1', $this->language->get('text_report_date').": ".date($this->config->get('advso' . $user_id . '_hour_format') == '24' ? "Y-m-d H:i:s" : "Y-m-d h:i:s A"));

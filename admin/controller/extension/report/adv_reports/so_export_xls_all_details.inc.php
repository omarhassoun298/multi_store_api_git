<?php
	...
	if ($results) {
		...
		$option_names = $this->model_extension_report_adv_sales->getOrderOptionsNames();
		}
		}
		$tax_names = $this->model_extension_report_adv_sales->getOrderTaxNames();
		...
		in_array('all_campaign_name', $advso_settings_all_columns) ? $worksheet->setColumn($j,$j++,15) : '';
		in_array('all_campaign_code', $advso_settings_all_columns) ? $worksheet->setColumn($j,$j++,15) : '';
		...
		in_array('all_campaign_name', $advso_settings_all_columns) ? $worksheet->writeString($i, $j++, $this->language->get('column_campaign_name'), $boxFormatText) : '';
		in_array('all_campaign_code', $advso_settings_all_columns) ? $worksheet->writeString($i, $j++, $this->language->get('column_campaign_code'), $boxFormatText) : '';
		...
		$j = 0;
			...
			$excelRow = $i+1;			
				...
				in_array('all_campaign_name', $advso_settings_all_columns) ? $worksheet->write($i, $j++, $result['order_campaign_name'], $filter_report != 'abandoned_orders' ? $textFormat : $abtextFormat) : '';
				in_array('all_campaign_code', $advso_settings_all_columns) ? $worksheet->write($i, $j++, $result['order_campaign_code'], $filter_report != 'abandoned_orders' ? $textFormat : $abtextFormat) : '';

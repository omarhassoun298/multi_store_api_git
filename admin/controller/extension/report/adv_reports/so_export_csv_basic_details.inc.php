<?php
	...
	in_array('cr_coupon_amount', $advso_settings_cr_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . sprintf('%0.2f', round($result['coupon_amount_raw'], 2)) . $csv_enclosed : '';
	...
	in_array('cr_coupon_total', $advso_settings_cr_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . sprintf('%0.2f', round($result['coupon_total_raw'], 2)) . $csv_enclosed : '';
	...
	in_array('vr_voucher_amount', $advso_settings_vr_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . sprintf('%0.2f', round($result['voucher_amount_raw'], 2)) . $csv_enclosed : '';	
	in_array('vr_voucher_used_value', $advso_settings_vr_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . sprintf('%0.2f', round($result['voucher_used_value_raw'], 2)) . $csv_enclosed : '';	
	in_array('vr_voucher_remaining_value', $advso_settings_vr_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . sprintf('%0.2f', round($result['voucher_remaining_value_raw'], 2)) . $csv_enclosed : '';	
	...
	in_array('vr_voucher_total', $advso_settings_vr_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . sprintf('%0.2f', round($result['voucher_total_raw'], 2)) . $csv_enclosed : '';
	...
	in_array('mv_sub_total', $advso_settings_mv_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . sprintf('%0.2f', round($result['sub_total_raw'], 2)) . $csv_enclosed : '';
	in_array('mv_handling', $advso_settings_mv_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . sprintf('%0.2f', round($result['handling_raw'] !== NULL ? $result['handling_raw'] : 0, 2)) . $csv_enclosed : '';
	in_array('mv_loworder', $advso_settings_mv_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . sprintf('%0.2f', round($result['low_order_fee_raw'] !== NULL ? $result['low_order_fee_raw'] : 0, 2)) . $csv_enclosed : '';
	in_array('mv_shipping', $advso_settings_mv_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . sprintf('%0.2f', round($result['shipping_raw'] !== NULL ? $result['shipping_raw'] : 0, 2)) . $csv_enclosed : '';
	in_array('mv_reward', $advso_settings_mv_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . sprintf('%0.2f', round($result['reward_raw'] !== NULL ? $result['reward_raw'] : 0, 2)) . $csv_enclosed : '';
	...
	in_array('mv_coupon', $advso_settings_mv_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . sprintf('%0.2f', round($result['coupon_raw'] !== NULL ? $result['coupon_raw'] : 0, 2)) . $csv_enclosed : '';
	in_array('mv_tax', $advso_settings_mv_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . sprintf('%0.2f', round($result['taxes_raw'] !== NULL ? $result['taxes_raw'] : 0, 2)) . $csv_enclosed : '';
	in_array('mv_credit', $advso_settings_mv_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . sprintf('%0.2f', round($result['credit_raw'] !== NULL ? $result['credit_raw'] : 0, 2)) . $csv_enclosed : '';
	in_array('mv_voucher', $advso_settings_mv_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . sprintf('%0.2f', round($result['voucher_raw'] !== NULL ? $result['voucher_raw'] : 0, 2)) . $csv_enclosed : '';
	in_array('mv_commission', $advso_settings_mv_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . sprintf('%0.2f', round($result['commission_raw'] !== NULL ? -$result['commission_raw'] : 0, 2)) . $csv_enclosed : '';
	in_array('mv_total', $advso_settings_mv_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . sprintf('%0.2f', round($result['total_raw'], 2)) . $csv_enclosed : '';
	in_array('mv_aov', $advso_settings_mv_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . sprintf('%0.2f', round($result['aov_raw'], 2)) . $csv_enclosed : '';
	in_array('mv_refunds', $advso_settings_mv_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . ($result['refunds_raw'] != NULL ? sprintf('%0.2f', round($result['refunds_raw'], 2)) : sprintf('%0.2f', round('0', 2))) . $csv_enclosed : '';
	}
	...
	in_array('pl_prod_order_id', $advso_settings_pl_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed : '';
	in_array('pl_prod_date_added', $advso_settings_pl_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed : '';
	in_array('pl_prod_id', $advso_settings_pl_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed : '';
	in_array('pl_prod_sku', $advso_settings_pl_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed : '';
	in_array('pl_prod_model', $advso_settings_pl_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed : '';
	in_array('pl_prod_name', $advso_settings_pl_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed : '';
	in_array('pl_prod_option', $advso_settings_pl_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed : '';
	in_array('pl_prod_attributes', $advso_settings_pl_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed : '';
	in_array('pl_prod_category', $advso_settings_pl_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed : '';
	in_array('pl_prod_manu', $advso_settings_pl_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed : '';
	in_array('pl_prod_currency', $advso_settings_pl_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed : '';
	in_array('pl_prod_price', $advso_settings_pl_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed : '';
	in_array('pl_prod_quantity', $advso_settings_pl_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed : '';
	in_array('pl_prod_total_excl_vat', $advso_settings_pl_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed : '';
	in_array('pl_prod_tax', $advso_settings_pl_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed : '';
	in_array('pl_prod_total_incl_vat', $advso_settings_pl_columns) ? $export_csv .= $csv_delimiter . $csv_enclosed . '' . $csv_enclosed : '';
